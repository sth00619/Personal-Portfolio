...
test('공개 빌드에 내부 브리프·문서·원본 자료가 들어가지 않는다',async()=>{
 ...
 assert.deepEqual((await readdir('dist')).sort(),['app.js','assets','data.js','index.html','projects-library.js','styles.css']);
 assert.deepEqual(await readdir('dist/assets'),['favicon.svg']);
});
